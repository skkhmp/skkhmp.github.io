...
# 컴퓨터 언어학 Computational Linguistics(CL)
컴퓨터 언어학은 컴퓨터적인 관점에서 언어를 연구하는 분야이다. 컴퓨터 언어학자들은 다양한 언어학적 현상에 대해 컴퓨터 모델을 제공하는데 관심이 있다. 컴퓨터 언어학의 주요 응용 분야는 다음과 같다. 
* 기계 번역 Machine Translation
* 자연 언어 인터페이스 Natural Language Interfaces
* 문법과 스타일 검사 Grammar and style checking
* 문서 프로세싱, 정보 검색 Document processing and information retrieval
